        ...
        <v-dialog v-model="dialog" max-width="500px">
          ...
          <v-card>
              ...
              <v-container>
                <v-row>
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field
                      v-model="editedItem.registro_ans"
                      label="Registro ANS"
                    ></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="6" md="4">
                  ...
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field
                      v-model="editedItem.razao_social"
                      label="Razão Social"
                    ></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="6" md="4">
                  ...
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field
                      v-model="editedItem.endereco_eletronico"
                  ...
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field
                      v-model="editedItem.cargo_representante"
                      label="Cargo Representante"
                    ></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field
                      v-model="editedItem.data_registro_ans"
            ...
            <v-card-actions>
              ...
              <v-btn color="blue darken-1" text @click="$emit('emitdata',editedItem)"> Save </v-btn>
            </v-card-actions>
          </v-card>
        </v-dialog>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "Endereço Eletrônico", value: "endereco_eletronico", sortable: false },
      { text: "Representante", value: "representante", sortable: false },
      { text: "Cargo Representante", value: "cargo_representante", sortable: false },
      { text: "Data Registro ANS", value: "data_registro_ans", sortable: false },
    ],
